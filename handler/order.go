...
func (oh *orderHandler) DeleteOrder(ctx *gin.Context) {
	...
	if err != nil {
		errResponse := errs.NewBadRequest("OrderId Has To Be a Valid ID ")
	...
	// Jika penghapusan berhasil, kembalikan respons yang diinginkan
	ctx.JSON(http.StatusOK, gin.H{"statusCode": http.StatusOK, "message": "Delete Order Successfully"})
}
